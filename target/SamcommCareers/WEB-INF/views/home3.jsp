...
<html lang="en">
  ...
  <head>
   ...
   <%--  <link href="${contextPath}/static/new/css/bootstrap.min.css" rel="stylesheet"> --%>
	<link rel="stylesheet" href="${contextPath}/static/new/css/font-awesome.min.css">
	<link href="${contextPath}/static/new/css/animate.min.css" rel="stylesheet">
    <link href="${contextPath}/static/new/css/prettyPhoto.css" rel="stylesheet">      
	<link href="${contextPath}/static/new/css/main.css" rel="stylesheet">
	<link href="${contextPath}/static/new/css/responsive.css" rel="stylesheet">
...
/* 				} */
 ...
 <body class="homepage">   
				...
				<div id="carousel-slider" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="item active">
							<img src="${contextPath}/static/new/images/slider_one.jpg" class="img-responsive" alt=""> 
					   </div>
					   <div class="item">
							<img src="${contextPath}/static/new/images/slider_one01.jpg" class="img-responsive" alt=""> 
					   </div> 
					   <div class="item">
							<img src="${contextPath}/static/new/images/slider_one02.jpg" class="img-responsive" alt=""> 
					   </div> 
					</div>
    ...
    <div class="container">
     <div class="card text-white my-4 text-center">
      <c:if test="${edit1}">
            <span class="well pull-left">
               <div class="alert alert-danger">
			    <strong>Already applied!</strong>  Please click on other jobs to apply.
			  </div>
            </span>
      </c:if>
      </div>
      ...
      <div class="card text-white bg-secondary my-4 text-center">
        <div class="card-body">
          <h5 class="text-white m-0">Latest Jobs</h5>
        </div>
      </div>
      ...
      <c:if test="${edit}">
            <span class="well pull-left">
               <div class="alert alert-success">
			    <strong>Successfully applied!</strong>  Please click on other jobs to apply.
			  </div>
            </span>
      </c:if>
      </div>
			 ...
			 <div class="col-md-4 mb-4">
	          <div class="card h-100">
	            <div class="card-body">
	              ...
	              <h5 class="card-title">${job.jobid}</h5>
	              <h4 class="card-title">${job.job_name}</h4>
	              
	              <p class="card-text"><p>${job.shortdescription}</p>
	            </div>
	            <div class="card-footer">
	              <a href="viewDetails?jobid=${job.jobid}&id=${job.id}" class="btn btn-info">Apply</a>
	...
	<script src="${contextPath}/static/new/js/jquery.js"></script>
    <script src="${contextPath}/static/new/js/bootstrap.min.js"></script>
    <script src="${contextPath}/static/new/js/jquery.prettyPhoto.js"></script>
    <script src="${contextPath}/static/new/js/jquery.isotope.min.js"></script>   
    <script src="${contextPath}/static/new/js/wow.min.js"></script>
	<script src="${contextPath}/static/new/js/main.js"></script>
    <script src="${contextPath}/static/vendor/jquery/jquery.min.js"></script>
	<script src="${contextPath}/static/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
